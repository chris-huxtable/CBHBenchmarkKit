...
@class CBHBenchmarkSample, CBHBenchmarkSamples;


NS_ASSUME_NONNULL_BEGIN

@interface CBHBenchmark : NSObject
...
- (instancetype)initWithSampleCount:(NSUInteger)samples andBlock:(void(^)(void))block NS_DESIGNATED_INITIALIZER;


#pragma mark - Properties

@property (readwrite, nonatomic) NSUInteger sampleCount;
@property (readwrite, nonatomic) BOOL shouldPreSample;
